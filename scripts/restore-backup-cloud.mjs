/**
 * Restaura backup JSON (backup-pg-full) en proyecto Supabase cloud NUEVO.
 *
 * .env.local:
 *   DATABASE_URL_NEW=postgresql://postgres:PASSWORD@db.dblphvmvusbgopcejbyh.supabase.co:5432/postgres
 *
 *   npm run db:restore:cloud
 *   npm run db:restore:cloud -- backups/2026-07-07_12-00-00
 */
import pg from 'pg';
