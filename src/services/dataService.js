...
export const getBrazosPendientesEntregaByOrg = (organizacionId) =>
  isSupabaseBackend()
...
export const getTurnosAgrupadosDisponibilidad = (cortejoId, organizacionId) =>
  isSupabaseBackend()
    ? sb.getTurnosAgrupadosDisponibilidad(cortejoId, organizacionId)
    : Promise.resolve(mock.getTurnosAgrupados(cortejoId, organizacionId));
...
export const contarReservasTaquillaColgadasOrg = (organizacionId) =>
  isSupabaseBackend()
    ? sb.contarReservasTaquillaColgadasOrg(organizacionId)
    : Promise.resolve(
        mock.contarReservasTaquillaColgadasOrgMock(organizacionId)
      );
