-- Optimización buscar_boleta_entrega: menos subconsultas + índice compra

CREATE INDEX IF NOT EXISTS idx_brazos_compra_vendido
  ON public.brazos(compra_id, numero_turno, numero_brazo)
